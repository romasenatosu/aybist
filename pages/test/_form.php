                        ...
                        <div class="container">
                            <form action="<?= "?locale=$locale&page=test&action=create" ?>" method="post">
                                ...
                                <div class="col-md-4">
                                        ...
                                        <input type="text" class="form-control" placeholder="<?= $lang['placeholder_title'] ?>" <?= $test->title->get_attr() ?>>
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <textarea class="form-control" placeholder="<?= $lang['label_description'] ?>" <?= $test->description->get_attr() ?>><?= $test->description->value ?></textarea>
