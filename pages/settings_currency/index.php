...
if ($language_id > 0) {
    $stmt = $pdo->prepare("SELECT * FROM settings_currency WHERE language_id = :language_id");
            ...
            <div class="col-12">
                <div class="card">
                                ...
                                <tbody>
                                    <?php foreach($data as $datum): ?>
                                        ...
                                        <tr>
                                            ...
                                            <td class="col-1">
                                                <a href="<?= "?locale=$locale&page=settings_currency&action=read&id=$data_id" ?>">
                                                    <i class="ti ti-eye" title="<?= $lang['text_read'] ?>" data-bs-toggle="tooltip"></i>
                                                </a>
                                                <a href="<?= "?locale=$locale&page=settings_currency&action=update&id=$data_id" ?>">
                    ...
                    <div class="card-footer text-end">
                        <a class="btn btn-primary" href="<?= "?locale=$locale&page=settings_currency&action=create" ?>"><?= $lang['text_new'] ?></a>
                    </div>
                </div>
            </div>
        </div>
