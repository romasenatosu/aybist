            ...
            <div class="col-12">
                <div class="card">
                            ...
                            <table class="table border table-hover table-striped table-bordered text-nowrap display datatable">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>14.11.2023</td>
                                        <td class="col-1">
                                            <a href="<?= "?locale=$locale&page=places_countries&action=read&id=1" ?>">
                                                <i class="ti ti-eye" title="Göster" data-bs-toggle="tooltip"></i>
                                            </a>
                                            <a href="<?= "?locale=$locale&page=places_countries&action=update&id=1" ?>">
                    ...
                    <div class="card-footer text-end">
                        <a class="btn btn-primary" href="?page=places_countries&action=create">Yeni Ekle</a>
                    </div>
                </div>
            </div>
        </div>
