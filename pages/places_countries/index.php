        ...
        <div class="col-12">
            <div class="card">
                            ...
                            <tbody>
                                <?php foreach($data as $datum): ?>
                                    ...
                                    <tr>
                                        ...
                                        <td class="col-1">
                                            <a href="<?= "/$locale/places_countries/read/$data_id" ?>">
                                                <i class="ti ti-eye" title="<?= $lang['text_read'] ?>" data-bs-toggle="tooltip"></i>
                                            </a>
                                            <a href="<?= "/$locale/places_countries/update/$data_id" ?>">
                ...
                <div class="card-footer text-end">
                    <a class="btn btn-primary" href="<?= "/$locale/places_countries/create" ?>"><?= $lang['text_new'] ?></a>
                </div>
            </div>
        </div>
    </div>
