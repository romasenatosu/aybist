...
if (Helpers::getRequestMethod() == 'POST') {
    ...
    if ($checks and Helpers::all($photo_checks)) {
        ...
        $stmt->bindParam(":language_id", $defualt_lang_code_id, PDO::PARAM_INT);
        $stmt->execute();
        ...
        // create language definitions
        $stmt = $pdo->prepare("INSERT INTO settings_contact (language_id, address, phone, phone_code_id, 
        ...
        $stmt->bindParam(":phone_code_id", $phone_code_id, PDO::PARAM_INT);
        $stmt->bindParam(":cell_phone", $cell_phone, PDO::PARAM_STR);
        $stmt->bindParam(":cell_phone_code_id", $cell_phone_code_id, PDO::PARAM_INT);
        $stmt->bindParam(":fax", $fax, PDO::PARAM_STR);
        $stmt->bindParam(":fax_code_id", $fax_code_id, PDO::PARAM_INT);
        $stmt->bindParam(":email", $email, PDO::PARAM_STR);
        $stmt->bindParam(":captcha_key", $captcha_key, PDO::PARAM_STR);
        $stmt->bindParam(":captcha_secret_key", $captcha_secret_key, PDO::PARAM_STR);
