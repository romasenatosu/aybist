        ...
        <div class="col-12">
            <div class="card">
                            ...
                            <tbody>
                                <?php foreach($data as $datum): ?>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php if ($datum['flag']): ?>
                                                <a href="<?= Helpers::getHost() . $datum['flag'] ?>">
                ...
                <div class="card-footer text-end">
                    <a class="btn btn-primary" href="<?= "/$locale/languages/create" ?>"><?= $lang['text_new'] ?></a>
                </div>
            </div>
        </div>
    </div>
