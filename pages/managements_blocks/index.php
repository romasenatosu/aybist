        ...
        <div class="col-12">
            <div class="card">
                            ...
                            <tbody>
                                <?php foreach($data as $datum): ?>
                                    ...
                                    <tr>
                                        ...
                                        <td class="col-1">
                                            <a href="<?= "/$locale/managements_blocks/read/$data_id" ?>">
                                                <i class="ti ti-eye" title="<?= $lang['text_read'] ?>" data-bs-toggle="tooltip"></i>
                                            </a>
                                            <a href="<?= "/$locale/managements_blocks/update/$data_id" ?>">
                ...
                <div class="card-footer text-end">
                    <a class="btn btn-primary" href="<?= "/$locale/managements_blocks/create" ?>"><?= $lang['text_new'] ?></a>
                </div>
            </div>
        </div>
    </div>
