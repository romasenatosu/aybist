            ...
            <div class="col-12">
                <div class="card">
                            ...
                            <table class="table border table-hover table-striped table-bordered text-nowrap display datatable">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>14.11.2023</td>
                                        <td class="col-1">
                                            <a href="?page=raporlar&action=read">
                                                <i class="ti ti-eye" title="Göster" data-bs-toggle="tooltip"></i>
                                            </a>
                                            <a href="?page=raporlar&action=update&id=1">
                                    ...
                                    <tr>
                                        ...
                                        <td class="col-1">
                                            ...
                                            <a href="?page=raporlar&action=update&id=2">
                                                <i class="ti ti-pencil" title="Düzenle" data-bs-toggle="tooltip"></i>
                                            </a>
                                            <?php
                                                include __DIR__ . '/_delete_form.php';
                    ...
                    <div class="card-footer text-end">
                        <a class="btn btn-primary" href="?page=raporlar&action=create">Yeni Ekle</a>
                    </div>
                </div>
            </div>
