...
$stmt = $pdo->prepare("SELECT u.id, u.fullname, u.email, u.phone, CONCAT('+', c.phone_code) AS phone_code,
 u.address, u.avatar, u.is_admin, u.is_root, u.created_at, u.updated_at
FROM users u
        ...
        <div class="col-12">
            <div class="card">
                            ...
                            <tbody>
                                <?php foreach($data as $datum): ?>
                                    ...
                                    <tr>
                                        ...
                                        <td class="col-1">
                                            <a href="<?= "/$locale/settings_users/read/$data_id" ?>">
                                                <i class="ti ti-eye" title="<?= $lang['text_read'] ?>" data-bs-toggle="tooltip"></i>
                                            </a>
                                            <a href="<?= "/$locale/settings_users/update/$data_id" ?>">
                ...
                <div class="card-footer text-end">
                    <a class="btn btn-primary" href="<?= "/$locale/settings_users/create" ?>"><?= $lang['text_new'] ?></a>
                </div>
            </div>
        </div>
    </div>
