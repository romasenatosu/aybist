        ...
        <div class="row">
            <div class="col-lg-8 col-md-10 mx-auto">
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="container">
                            <form action="<?= "?locale=$locale&page=settings_users&action=" . (($id <= 0) ? "create" : "update&id=$id") ?>" method="post" enctype="multipart/form-data">
                                <div class="row gx-md-4 gx-0 gy-4 mb-3 align-items-baseline">
                                    ...
                                    <div class="col-md-6">
                                        <div class="row gx-md-4 gx-0 gy-4 align-items-center">
                                            ...
                                            ?>
                                                <div class="col-2">
                                                    <a href="<?= Helpers::getServer() . $users->avatar->value ?>">
