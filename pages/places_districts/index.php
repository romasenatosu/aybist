            ...
            <div class="col-12">
                <div class="card">
                            ...
                            <table class="table border table-hover table-striped table-bordered text-nowrap display datatable">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>14.11.2023</td>
                                        <td class="col-1">
                                            <a href="<?= "?locale=$locale&page=places_districts&action=read&id=1" ?>">
                                                <i class="ti ti-eye" title="<?= $lang['text_read'] ?>" data-bs-toggle="tooltip"></i>
                                            </a>
                                            <a href="<?= "?locale=$locale&page=places_districts&action=update&id=1" ?>">
                    ...
                    <div class="card-footer text-end">
                        <a class="btn btn-primary" href="<?= "?locale=$locale&page=places_districts&action=create" ?>"><?= $lang['text_new'] ?></a>
                    </div>
                </div>
            </div>
        </div>
